...
%current_count_next2 = load i32, i32* %b
%current_count_incr2 = add i32 %current_count_next2, 1
store i32 %current_count_incr2, i32* %b
br label %loop2.cond
loop2.end:
...
@mensaje_write2 = private unnamed_addr constant [6 x i8] c"hola\00\00"
